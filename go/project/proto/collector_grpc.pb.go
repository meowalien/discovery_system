...
const (
	CollectorService_Collect_FullMethodName = "/collector.CollectorService/Collect"
)
...
type CollectorServiceClient interface {
	...
	Collect(ctx context.Context, in *CollectorRequest, opts ...grpc.CallOption) (*CollectorResponse, error)
}
...
func (c *collectorServiceClient) Collect(ctx context.Context, in *CollectorRequest, opts ...grpc.CallOption) (*CollectorResponse, error) {
...
type CollectorServiceServer interface {
	// Collect 方法接收 CollectorRequest 並回傳 CollectorResponse
	Collect(context.Context, *CollectorRequest) (*CollectorResponse, error)
...
func (UnimplementedCollectorServiceServer) Collect(context.Context, *CollectorRequest) (*CollectorResponse, error) {
...
func _CollectorService_Collect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CollectorServiceServer).Collect(ctx, req.(*CollectorRequest))
	}
...
var CollectorService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "project/proto/collector.proto",
}
