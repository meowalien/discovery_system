...
#     _logger.info("Received init sign in request")
#     try:
#         result = await init_sign_in(req.api_id, req.api_hash, req.phone, req.password)
#     except Exception as e:
#         _logger.error(f"Error during init sign in: {e}")
...
#     else:
#         _logger.error("Invalid init sign in status")
...
#     _logger.info("Received sign in code request")
#     try:
...
#         )
#     except Exception as e:
#         _logger.error(f"Error during sign in code process: {e}")
#         raise HTTPException(status_code=400, detail=str(e))
#     _logger.info("Completed sign in code request")
#     return result
#
#
# @router.post("/list_dialogs")
# async def list_dialogs_endpoint(req: CodeSignInRequest):
#     _logger.info("Received list dialogs request")
#     try:
#         result = await complete_sign_in(
#             api_id=req.api_id,
#             api_hash=req.api_hash,
...
#         )
#     except Exception as e:
#         _logger.error(f"Error during list dialogs process: {e}")
#         raise HTTPException(status_code=400, detail=str(e))
#     _logger.info("Completed list dialogs request")
#     return result